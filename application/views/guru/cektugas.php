    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            ...
            <div class="card shadow md-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('guru/update_tugas'); ?>" method="post">
                                    ...
                                    <?php foreach ($ambil as $a) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input name="nilai[]" type="number" min="0" max="100" class="form-control form-control-sm" value="<?= $a->nilai; ?>" required>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
