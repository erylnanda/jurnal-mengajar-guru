    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning bg-warning" style="color: #000; font-size: small;">
                <b>Petunjuk : </b><br>
                <ul>
                    <li>Menu ini digunakan untuk menginput nilai Tugas pada mata pelajaran <b><i><?php echo $detil_mp['namamapel'] . ", kelas " . $detil_mp['kelas'] . " " . $detil_mp['namakelas']; ?>.</i></b> </li>
                    ...
                    <li>Untuk mengisikan nilai Tugas pada masing-masing KD, silakan pilih nama KD pada form input nilai. Nilai dalam <b><i>skala 1-100</i></b>. Jangan lupa klik tombol <b><i>Simpan</i></b> di sebelah bawah.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url(); ?>guru/cetaknk/<?php echo $detil_mp['kodemapel'] . "_" . $detil_mp['kodekelas']; ?>" class="btn btn-outline-warning" target="_blank"><i class="fa fa-print"></i> Cetak</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="card shadow">
                <div class="card-header">
                    <h6 class="m-0 text-gray-900">Nilai Tugas &raquo; <?php echo $detil_mp['namamapel'] . " - " . $detil_mp['kelas'] . " " . $detil_mp['namakelas']; ?></h6>
                </div>
                <div class="card-body">
                    <p>
        ...
        $.ajax({
            ...
            success: function(r) {
                ...
                if (r.status == "gagal") {
                    ...
                    noti("success", r.data);
                    window.location.assign("<?= base_url('guru/n_Tugas/'); ?>" + id_mengajar);
                }
            }
        });
        return false;
