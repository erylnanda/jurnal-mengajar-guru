        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a href="<?= base_url(); ?>master/addsiswa/<?= $dtkelas['kodekelas']; ?>" class="btn btn-outline-info btn-sm"><i class="fas fa-plus-circle"></i> Tambah Siswa</a>
                    <div class="btn-group">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($siswa as $sw) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url(); ?>master/editsiswa/<?= $sw['nis']; ?>/<?= $dtkelas['kodekelas']; ?>" class="btn btn-outline-warning btn-circle btn-sm" title="Edit Data"><i class="fas fa-edit"></i></a>
                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-6">
                            <label for="kodekls">Pilih Kelas</label> 
                                <select name="kodekls" id="kodekls" class="form-control" required>
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-sm-6">
                                <label for="kodejur" class="col-sm-6 col-form-label">Jurusan</label>
                                    <select name="kodejur" id="kodejur" class="form-control" required>
                                        <?php foreach ($kelas as $j) : ?>
                                            <option value="<?= $j['kodejurusan']; ?>" <?= ($dtkelas['kodejurusan'] == $j['kodejurusan']) ? 'selected' : ''; ?>><?= $j['kodejurusan']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row justify-content-center">
                                ...
                                <label for="semester">Masukan Semester</label>  
                                    <input type="text" class="form-control" name="semester" id="semester" value="<?= set_value('semester'); ?>" required>
                                </div>
                            </div>
                            <div class="custom-file col-sm-6">
                                <input type="file" name="berkas_excel" id="berkas" class="custom-file-input" accept=".xlsx, .xls" required>
